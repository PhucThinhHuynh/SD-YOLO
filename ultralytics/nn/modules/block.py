...
from .conv import Conv, DWConv, GhostConv, LightConv, RepConv, autopad, MSCBAM
...
class C2fDMSC(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.cv1 = Conv(c1, 2 * self.c, 1, 1)
        self.cv2 = Conv((2 + n) * self.c, c2, 1)  # optional act=FReLU(c2)
        self.m = nn.ModuleList((DMSC(self.c, self.c, 3, 1, g, 1, shortcut) for _ in range(n)))
